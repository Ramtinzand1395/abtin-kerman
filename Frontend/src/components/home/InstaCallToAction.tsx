...
const InstaCallToAction = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-6 gap-5 h-[40vh] my-10'>
        {/* image */}
        <div className="md:col-span-4">
            <img src={img} className='overflow-hidden h-[40vh] w-full rounded-2xl' alt="" />
        </div>
        {/* Insta */}
...
<p>مشاهده آخرین جشنواره ها، تخفیف ها، محصولات جدید و اطلاع رسانی های فروشگاه</p>
        </div>
    </div>
  )
}
