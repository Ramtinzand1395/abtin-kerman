        ...
        <div className="flex">
          <div className="relative w-full">
            <input
              ...
              id="search-dropdown"
              className="block p-2.5 w-[50vw] z-20 text-sm text-gray-900  rounded-2xl border-2 border-[#054f7e] focus:ring-blue-500 focus:border-blue-500"
            />
            <button
              type="submit"
              className="absolute top-0 end-0 p-2.5 w-28 font-medium h-full text-sm text-white bg-[#054f7e] rounded-e-2xl border  hover:bg-[#23867d] focus:ring-4 focus:outline-none focus:ring-blue-300 "
            >
              جستجو
            </button>
          </div>
